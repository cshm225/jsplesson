...
<%
	Dounut donut=(Dounut)request.getAttribute("donut");
%>
<!DOCTYPE html>
<html>
<head>
...
<body>
<form action="/donatapp/Admin/Update" method="post" enctype="multipart/form-data">
...
<img src="/donatapp/upload/<%=donut.getImgname()%>" id="preview"><br>
